(ns schoolops.operation
  ...
  (:require [langgraph.graph :as g]
            ...
            [schoolops.governor :as governor]
            [schoolops.phase :as phase]
...
(defn build
  ...
  `schoolops.store/Store`).
  opts:
    :advisor      -- an `schoolops.advisor/Advisor` (default: mock-advisor)
            ...
            (case disposition
              ...
              {:disposition :escalate
               :audit [{:t :approval-requested
                        :op (:op request) :student-id (:student-id request)
                        :reason (or reason
          ...
          (if (= :approved (:status approval))
            {:disposition :commit
             ...
             :audit [{:t :approval-granted :op (:op request)
                      :student-id (:student-id request) :by (:by approval)}]}
            {:disposition :hold
