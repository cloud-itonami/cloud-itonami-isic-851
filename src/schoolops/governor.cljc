(ns schoolops.governor
  "SchoolOpsGovernor -- the independent compliance layer for school
  administrative coordination. The advisor has no notion of whether a
  student is actually registered and verified in the school roster,
  ...
  `schoolops.phase` independently agrees: `:flag-safety-concern` is
...
(defn check
  "Censors a SchoolOpsAdvisor proposal against the governor rules.
