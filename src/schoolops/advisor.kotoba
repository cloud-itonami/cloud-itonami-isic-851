(ns schoolops.advisor
  "SchoolOpsAdvisor -- the *contained intelligence node* for the
  ...
  `:propose`. Every output is censored downstream by `schoolops.governor`
  ...
  `schoolops.governor`'s `scope-exclusion-violations` independently
...
(defn- propose-safety-concern
  "Surface a student/school safety concern (suspected abuse/neglect,
  bullying reports, injury, wellbeing incidents) for HUMAN triage.
  This op ALWAYS escalates in `schoolops.governor` -- never auto-committed
