(ns schoolops.store
  ...
  This actor coordinates the back-office operations of a primary school:
  ...
  or any safety-authority override -- see `schoolops.governor`'s
  ...
  for that student may ever commit or escalate -- `schoolops.governor`'s
  ...
  (`test/schoolops/store_contract_test.clj`), which is the whole point:
  the actor, `schoolops.governor` and the audit ledger never know which
  SSoT they run on."
