# Operator Quickstart — Pre-primary and Primary Education

Shortest path from clone to a verified local dry-run for **ISIC 851** (`cloud-itonami-isic-851`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-851.git
cd cloud-itonami-isic-851
```
...
- Blueprint governor key: `schoolops-governor`
- Likely source path: `schoolops.governor.cljc`
...
- Export the audit ledger on a schedule: it is your evidence trail for
  a district/board review of any commit, hold or escalation.
